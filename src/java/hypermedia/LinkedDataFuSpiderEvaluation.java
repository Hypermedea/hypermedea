 ...
 */
public class LinkedDataFuSpiderEvaluation extends Artifact {
	...
	public LinkedDataFuSpiderEvaluation() {
	 ...
	 */
	@OPERATION
	public void crawl(String originURI, OpFeedbackParam<Double> op_time){
	 ...
	 */
	@OPERATION
	public void get(String originURI, boolean local, boolean inferred, OpFeedbackParam<Double> op_time) {
		try {
			long startTime = System.currentTimeMillis();
